 ...
 * Use the [DashBoardRentishFragment.newInstance] factory method to
...
class DashBoardRentishFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DashBoardRentishFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DashBoardRentishFragment().apply {
